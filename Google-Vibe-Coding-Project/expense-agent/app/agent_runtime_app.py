...
class AgentEngineApp(AdkApp):
    def set_up(self) -> None:
        ...
        try:
            ...
            logging.warning(f"Failed to initialize Vertex AI: {e}. Local mode will be used.")
        ...
        try:
            ...
            logging.warning(f"Failed to initialize Google Cloud Logging: {e}. Using standard logging.")
